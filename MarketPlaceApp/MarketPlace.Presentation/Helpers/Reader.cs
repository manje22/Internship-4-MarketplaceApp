    ...
    public class Reader
    {
        ...
        public static DateTime InputDate(string message)
        {
            ...
            do
            {
                ...
                success = DateTime.TryParseExact(dateInput, "yyyy-MM-dd", CultureInfo.InvariantCulture, DateTimeStyles.None, out date);
            } while (!success);
            Console.WriteLine($"Uspjesno unesen datum {date.ToShortDateString()}\n");
            return date;
        }
